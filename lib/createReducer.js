...
exports.createAsyncReducer = (types, initState = {}, updates) => {
    ...
    const defaultUpdates = {
        [request]: (state) => Object.assign({}, state, { pending: true }),
        [success]: (state, action) => Object.assign({}, state, Object.assign({}, action.payload, { pending: false })),
        [fail]: (state, action) => Object.assign({}, state, {
            error: action.error,
            pending: false
        })
    };
