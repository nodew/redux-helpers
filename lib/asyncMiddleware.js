...
function asyncMiddleware(fetch) {
    return ({ dispatch, getState }) => {
        return next => action => {
            ...
            actionPromise.then((result) => next(Object.assign({}, rest, { payload: result, type: SUCCESS })), (error) => next(Object.assign({}, rest, { error, type: FAILURE }))).catch((error) => {
